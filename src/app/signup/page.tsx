    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="neon-frame p-6">
          <div className="mb-6">
            <h2 className="text-lg font-heading font-bold text-foreground">Create account</h2>
            <p className="text-xs text-muted-foreground mt-1">
              <span className="text-neon">_</span> Start your outreach campaign
            </p>
          </div>
          ...
          <p className="mt-4 text-center text-xs font-mono text-muted-foreground">
            ...
            <Link href="/login" className="text-neon hover:text-glow transition-colors">
              Sign in
            </Link>
          </p>
        </div>
